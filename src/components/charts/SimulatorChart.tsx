...
export default function SimulatorChart({ data, isAnimationActive }: { data: ChartDataItem[], isAnimationActive: boolean }) {
  return (
    <>
      <span id="simulator-desc" className="sr-only">
        Simulation Comparison Chart displaying differences in emissions between the baseline and various simulation scenarios.
      </span>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart 
          ...
          role="img" aria-label="Simulation Comparison Chart" data={data} margin={{ top: 0, right: 30, left: 0, bottom: 0 }} layout="vertical">

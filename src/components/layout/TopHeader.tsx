...
export function TopHeader() {
  return (
    <header className="sticky top-0 z-30 flex h-[var(--layout-header-height)] w-full items-center justify-between border-b border-border/30 bg-background/80 px-4 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">

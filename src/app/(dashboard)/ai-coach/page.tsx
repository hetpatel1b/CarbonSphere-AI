      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-sm text-muted-foreground">
            Personalized, data-driven sustainability diagnostics generated by Gemini AI.
          </p>
        </div>
        ...
        >
          ...
          {isGenerating ? "Analyzing Profile..." : "Generate New Analysis"}
        </button>
      </div>
      ...
      {!data?.insight ? (
        <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-3xl bg-zinc-50 dark:bg-zinc-950/50">
          ...
          <p className="text-muted-foreground text-sm text-center max-w-md mt-2">
            Click the &quot;Generate New Analysis&quot; button above to have Gemini AI analyze your logged activities and create a personalized plan.
          </p>
        </div>
      ) : (
            ...
            <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-emerald-50 dark:bg-emerald-950/20 p-6 flex flex-col sm:flex-row items-center sm:items-start gap-5 shadow-sm">
              ...
              <div className="text-center sm:text-left space-y-2">
                ...
                <h3 className="text-lg font-black text-foreground leading-snug">
                  {data.insight.monthlyGoal || "Continue reducing your carbon footprint through steady daily actions."}
                </h3>
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 pt-2">
                  <div className="flex items-center gap-1.5 text-xs font-semibold text-emerald-600 dark:text-emerald-400">
                    <TrendingDown className="h-4 w-4" />
                    Potential Saving: {data.insight.carbonReductionPotential || "Unknown"}
                  </div>
